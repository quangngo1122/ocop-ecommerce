...
export default function AdminOrderPage() {
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((order) => {
      ...
      const matchesSearch =
        ...
        (order.shop_id?.name || "").toLowerCase().includes(term);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, statusFilter, minTotal, maxTotal, itemsPerPage]); // Added itemsPerPage to reset triggers
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-2 mb-6">
        <span className="w-1 h-6 bg-orange-400 rounded-sm inline-block" />
        <h1 className="text-2xl font-bold">Quản Lý Đơn Hàng Toàn Hệ Thống</h1>
      </div>
      ...
      <div className="my-3">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 sm:grid-cols-1">
          <div>
            <input
              type="text"
              placeholder="Tìm kiếm theo mã, tên, email, trạng thái, shop..."
          ...
          <div>
            <select
              className="hover:border-blue-400 cursor-pointer w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
              value={statusFilter}
              onChange={(e) => {
      ...
      <div className="overflow-x-auto bg-white border border-gray-300 rounded-lg shadow">
        <table
          className={`${
            viewMode === "table"
              ? "hidden md:table w-full table-auto"
              : "hidden"
          }`}
        >
          <ColAllPageSeller type={"adminOrder"} />
          <tbody>
              ...
              paginatedOrders.map((order, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 break-all min-w-[130px] py-2 text-center border border-gray-300">
                    ...
                    <td className="px-1 py-2 text-center border-gray-300 border">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="lg:ml-4 min-w-[140px]">
                          {productName}
                        </span>
                      </div>
                    </td>
                    <td className="px-2 min-w-[160px] py-2 text-center border border-gray-300">
                      <button
                        onClick={() =>
                    ...
                    <td className="px-2 py-2 min-w-[110px] text-center border border-gray-300">
                      {/* {user.fullName} */}
                      <button
                        onClick={() =>
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <p>
                      ...
                      <button
                        ...
                        className="cursor-pointer text-indigo-500 font-semibold hover:font-bold"
                      >
                        {order.shop_id?.name || "N/A"}
                      </button>
                    </p>
